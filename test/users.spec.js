...
describe('Cin7.users', function() {
    ...
    describe('#get()', function() {
        context('when using default options', function() {
            it('should create output/users.json', function(done) {
                cin7.users.get().then((response) => {
                    return response.text();
                }).then((text) => {
                  // make a file system agnostic file name
                  let fileName = 'output' + path.sep + 'users.json';
            ...
            it('should create output/users.csv', function(done) {
                cin7.users.get().then((response) => {
                    ...
                    // write the csv file
                    let fileName = 'output' + path.sep + 'users.csv';
        ...
        context('when using page options', function() {
            it('should get two pages and concat them', function(done) {
                ...
                cin7.users.get(options).then((response) => {
                    return response.json();
                }).then((data) => {
