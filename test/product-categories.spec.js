...
describe('Cin7.productCategories', function() {
    before(function() {
        cin7 = new Cin7();
    });
    ...
    describe('#get()', function() {
        context('when using default options', function() {
            it('should create output/product-categories.json', function(done) {
                this.timeout(5000);

                cin7.productCategories.get().then((response) => {
            ...
            it('should create output/product-categories.csv', function(done) {
                this.timeout(5000);
        ...
        context('when using page options', function() {
            it('should get two pages and concat them', function(done) {
                ...
                cin7.productCategories.get(options).then((response) => {
                    return response.json();
                }).then((data) => {
                    ...
                    options.page++;
                    return cin7.productCategories.get(options);
                }).then((response) => {
                    return response.json();
                }).then((data) => {
                    rows = rows.concat(data);
